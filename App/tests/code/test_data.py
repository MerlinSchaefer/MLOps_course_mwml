...
@pytest.mark.parametrize(
    "tag, include, tag_none",
    [("tag", None, None), ("tag", ["tag"], "tag"), ("tag", ["other_tag"], None)],
)
def test_filter(tag, include, tag_none):
    assert data.filter(tag=tag, include=include) == tag_none
...
class TestLabelEncoder:
    ...
    def test_empty_init(self):
        ...
        assert label_encoder.class_to_index == {}
    ...
    def test_fit(self):
        ...
        assert label_encoder.classes == ["apple", "banana"]
